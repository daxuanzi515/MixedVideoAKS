...
def get_prompts(json_file):
    ...
    cmds = []
    img_path = "/home/cxx/HWs/AKS/Mixed Video Pipeline/Testing/outputs/Shooting/class_1/jpgs"
    
    for idx, d in enumerate(data[240:360]):
        path = d['video_path']
    ...
    with open('/home/cxx/HWs/AKS/Mixed Video Pipeline/Testing/Shooting_class_1_cmd.txt', 'w') as f:
        for cmd in cmds:
            f.write(' '.join(shlex.quote(arg) for arg in cmd) + '\n')
    
    print(f"✅ Prompts saved to '/home/cxx/HWs/AKS/Mixed Video Pipeline/Testing/Shooting_class_1_cmd.txt'")
    return cmds
...
with open('/home/cxx/HWs/AKS/Mixed Video Pipeline/Testing/Shooting_class_1_cmd.txt', 'r') as f:
    cmds = [line.strip() for line in f.readlines()]  # Strip newline characters
res_path = "/home/cxx/HWs/AKS/Mixed Video Pipeline/Testing/Shooting_class_1_res.txt"
res = []
group_size = 4
total_cmds = len(cmds)
